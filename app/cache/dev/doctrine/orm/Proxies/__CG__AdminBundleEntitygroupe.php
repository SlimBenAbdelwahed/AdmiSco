 ...
 */
class groupe extends \Admin\Bundle\Entity\groupe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Bundle\\Entity\\groupe' . "\0" . 'id', '' . "\0" . 'Admin\\Bundle\\Entity\\groupe' . "\0" . 'nomGroupe', '' . "\0" . 'Admin\\Bundle\\Entity\\groupe' . "\0" . 'idNiveau');
        }
