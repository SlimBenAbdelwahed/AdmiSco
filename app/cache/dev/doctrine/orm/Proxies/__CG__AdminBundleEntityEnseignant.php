 ...
 */
class Enseignant extends \Admin\Bundle\Entity\Enseignant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Bundle\\Entity\\Enseignant' . "\0" . 'id', '' . "\0" . 'Admin\\Bundle\\Entity\\Enseignant' . "\0" . 'nom', '' . "\0" . 'Admin\\Bundle\\Entity\\Enseignant' . "\0" . 'prenom', '' . "\0" . 'Admin\\Bundle\\Entity\\Enseignant' . "\0" . 'dateDeNaissance', '' . "\0" . 'Admin\\Bundle\\Entity\\Enseignant' . "\0" . 'email', '' . "\0" . 'Admin\\Bundle\\Entity\\Enseignant' . "\0" . 'telephone', '' . "\0" . 'Admin\\Bundle\\Entity\\Enseignant' . "\0" . 'site');
        }
