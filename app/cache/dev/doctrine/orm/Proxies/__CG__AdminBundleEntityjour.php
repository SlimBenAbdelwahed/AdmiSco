 ...
 */
class jour extends \Admin\Bundle\Entity\jour implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Bundle\\Entity\\jour' . "\0" . 'id', '' . "\0" . 'Admin\\Bundle\\Entity\\jour' . "\0" . 'designation');
        }
