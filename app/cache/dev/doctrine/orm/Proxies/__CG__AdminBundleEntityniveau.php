 ...
 */
class niveau extends \Admin\Bundle\Entity\niveau implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Bundle\\Entity\\niveau' . "\0" . 'id', '' . "\0" . 'Admin\\Bundle\\Entity\\niveau' . "\0" . 'niveau', '' . "\0" . 'Admin\\Bundle\\Entity\\niveau' . "\0" . 'idFiliere');
        }
