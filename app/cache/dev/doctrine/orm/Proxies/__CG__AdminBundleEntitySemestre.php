 ...
 */
class Semestre extends \Admin\Bundle\Entity\Semestre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Bundle\\Entity\\Semestre' . "\0" . 'id', '' . "\0" . 'Admin\\Bundle\\Entity\\Semestre' . "\0" . 'numSemestre');
        }
