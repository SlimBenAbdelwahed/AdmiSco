...
use Admin\Bundle\Entity\Matiere;
use Admin\Bundle\Form\MatiereType;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdmiScoBundle:Matiere')->findAll();

        return $this->render('AdmiScoBundle:Matiere:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AdmiScoBundle:Matiere:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdmiScoBundle:Matiere')->find($id);
        ...
        return $this->render('AdmiScoBundle:Matiere:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdmiScoBundle:Matiere:edit.html.twig', array(
            'entity'      => $entity,
