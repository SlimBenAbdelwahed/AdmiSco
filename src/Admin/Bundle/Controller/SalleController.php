...
use Admin\Bundle\Entity\Salle;
use Admin\Bundle\Form\SalleType;
...
class SalleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdmiScoBundle:Salle')->findAll();

        return $this->render('AdmiScoBundle:Salle:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AdmiScoBundle:Salle:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdmiScoBundle:Salle')->find($id);
        ...
        return $this->render('AdmiScoBundle:Salle:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdmiScoBundle:Salle:edit.html.twig', array(
            'entity'      => $entity,
