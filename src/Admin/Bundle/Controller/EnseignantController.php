...
use Admin\Bundle\Entity\Enseignant;
use Admin\Bundle\Form\EnseignantType;
...
class EnseignantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdmiScoBundle:Enseignant')->findAll();
        return $this->render('AdmiScoBundle:Enseignant:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AdmiScoBundle:Enseignant:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdmiScoBundle:Enseignant')->find($id);
        ...
        return $this->render('AdmiScoBundle:Enseignant:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdmiScoBundle:Enseignant:edit.html.twig', array(
            'entity'      => $entity,
