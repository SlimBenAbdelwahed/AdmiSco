...
use Admin\Bundle\Entity\Admin;
use Admin\Bundle\Form\AdminType;
...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdmiScoBundle:Admin')->findAll();

        return $this->render('AdmiScoBundle:Admin:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AdmiScoBundle:Admin:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdmiScoBundle:Admin')->find($id);
        ...
        return $this->render('AdmiScoBundle:Admin:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdmiScoBundle:Admin:edit.html.twig', array(
            'entity'      => $entity,
